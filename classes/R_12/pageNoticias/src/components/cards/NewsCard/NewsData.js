export default [
    {
        id: 0,
        title: "Estafaron a una mujer de 77 años en 80.000 pesos",
        description: "Una mujer de 77 años denunció en la policía que tuvo un movimiento en su cuenta bancaria por un importe de 80.000 pesos el cual no fue autorizado. Intervino la UFI N°14 por “estafa”.",
    ...
    {
        id: 1,
        title: "Detuvieron a un sujeto que amenazó a una inspectora",
        description: "Personal de GTO Comisaría Primera junto con Comando Patrulla detuvo en una vivienda de calle Guruciaga al 850 a un sujeto de 24 años y secuestró una motocicleta marca Honda Twister.",
    ...
    {
        id: 2,
        title: "Dos vehículos protagonizaron un choque en Ameghino y Roca",
        description: "La Policía Local se hizo presente en Ameghino y Roca, donde se produjo un accidente de tránsito entre dos autos. Se trata de un DS, guiado por una mujer de 54 años, y un Toyota Land, al mando de una mujer de 38.",
    ...
    {
        id: 3,
        title: "Un automovilista colisionó con un peatón y el vehículo terminó incrustado en el ex palacio municipal",
        description: "En horas de la madrugada de este sábado, Monitoreo municipal alertó al personal policial sobre una riña que estaba ocurriendo en calle Rivadavia y Pellegrini. Al arribar, se encontraron con un auto Toyota Corolla, guiado por un joven de 25 años, que colisionó con un peatón de 22 años y terminó incrustado en el ex palacio municipal.",
    ...
    {
        id: 4,
        title: "Hallaron una camioneta robada, cuyo conductor abandonó tras colisionar con un tapial",
        description: "Luego de un seguimiento controlado y un operativo cerrojo, personal policial procedió al secuestro de una camioneta que se encontraba estacionada en Payan y Lamadrid. Se trata de una S10, con dominio colocado que pertenecía a una Toyota Hilux. Finalmente, constataron por medio de los grabados de cristales que presentaba pedido de secuestro activo, a solicitud de la policía de Santa Fe.",
