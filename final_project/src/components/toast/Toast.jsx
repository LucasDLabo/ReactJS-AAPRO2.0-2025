...
function Toast({ message, type = "success", onClose }){
    ...
    return(
        <div className={`fixed right-0 bottom-10 left-0 z-50 mx-5 rounded px-2 py-4 text-start shadow-md md:right-6 md:bottom-6 md:left-auto md:mx-5 md:text-start ${styles[type]}`}>
