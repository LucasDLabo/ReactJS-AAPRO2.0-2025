...
function Toast({ message, type = "success", onClose, duration = 4000 }){
    ...
    return(
        <div className={`fixed right-0 bottom-6 left-0 z-[60] mx-5 transform rounded px-2 py-4 text-start shadow-md transition-all duration-300 md:right-6 md:left-auto md:mx-5 md:text-start ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"} ${styles[type]}`}>
